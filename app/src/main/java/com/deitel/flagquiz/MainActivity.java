...
public class MainActivity extends AppCompatActivity {
   ...
   public static final String LANGUAGES = "pref_numberOfLANG";
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      PreferenceManager.getDefaultSharedPreferences(this).
         registerOnSharedPreferenceChangeListener((SharedPreferences sharedPreferences, String key) -> {
              Log.d(TAG + "Pref", "Preference \"" + key + "\" changed");
              ...
              if (key.equals(LANGUAGES)) { // # of choices to display changed

                 final String selectedLang = sharedPreferences.getString(MainActivity.LANGUAGES, null);




//                 Locale locale = new Locale(selectLang);
...
//                 finish();
                 MyApplication.updateLanguage(MainActivity.this.getBaseContext(), selectedLang);
                 Log.d(TAG + "Pref", "Selected language is " + selectedLang);


                 MyApplication.reloadApplication(MainActivity.this, MainActivity.class);
              }
